...
@section('content')
    <div class="card">
        <div class="card-body">
            <h1>Anonymous E-Sports Betting</h1>
            <div class="row">
                <div class="col-xl-6">
                    ...
                    @if(!$warmupMatches->isEmpty() or !$liveMatches->isEmpty())
                        @foreach($warmupMatches as $warmupMatch)
                            <div class="card mb-3">
                                <div class="card-header">
                                    ...
                                    <img class="float-right ml-2" src="{{ asset('img/'.$warmupMatch['game'].'_icon.png') }}" width="18" height="18">
                        ...
                        @foreach($liveMatches as $liveMatch)
                            <div class="card mb-3">
                                <div class="card-header">
                                    ...
                                    <img class="float-right ml-2" src="{{ asset('img/'.$liveMatch['game'].'_icon.png') }}" width="18" height="18">
                        ...
                        @endforeach
                    @else
                        <h1 class="text-warning pt-4">No Live Games...</h1>
                    @endif
                </div>
                <div class="col-xl-6">
                    ...
                    @if(!$upcomingMatches->isEmpty())
                        @foreach($upcomingMatches as $upcomingMatch)
                            <div class="card mb-3" style="height: 150px;">
                                <div class="card-header">
                                    ...
                                    <img class="float-right ml-2" src="{{ asset('img/'.$upcomingMatch['game'].'_icon.png') }}" width="18" height="18">
                        ...
                        @endforeach
                    @else
                        <h1 class="text-warning pt-4">No Upcoming Games...</h1>
                    @endif
                </div>
            </div>
            ...
            <div class="row">
                @if(!$endedMatches->isEmpty())
                    @foreach($endedMatches as $endedMatch)
                        <div class="card mb-3 mx-3" style="height: 150px; width: 48%;">
                            <div class="card-header">
                                ...
                                <img class="float-right ml-2" src="{{ asset('img/'.$endedMatch['game'].'_icon.png') }}" width="18" height="18">
                    ...
                    @endforeach
                @else
                    <h1 class="text-warning pt-4">No Game History...</h1>
                @endif
